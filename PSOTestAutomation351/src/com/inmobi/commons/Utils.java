...
public class Utils {
	...
	// ##############################################################################################################################
	public void loadAndShowInterstitialAd(IMAdRequest mIMAdRequest, final IMAdInterstitial imAdInterstitialViewObj, Activity testActivity) {
		imAdInterstitialViewObj.loadNewAd(mIMAdRequest);
	...
	public HashMap<String, String> getDeviceDetails() {
		...
		deviceDetails.put("sdkversion", "SDK-351");	// + IMCommonUtil.getReleaseVersion() );
